...
# Configure the zones
hnirrigationd_client --host localhost:8080 --create-zone --name "Front Grass East" --sec-per-week 2520 --sec-max-cycle 240 --sec-min-cycle 20 --swid-list "s11"
hnirrigationd_client --host localhost:8080 --create-zone --name "Front Grass West" --sec-per-week 3360 --sec-max-cycle 360 --sec-min-cycle 20 --swid-list "s10"
...
hnirrigationd_client --host localhost:8080 --create-zone --name "Back Fence West" --sec-per-week 1680 --sec-max-cycle 240 --sec-min-cycle 20 --swid-list "s22"
hnirrigationd_client --host localhost:8080 --create-zone --name "Back Fence East" --sec-per-week 1680 --sec-max-cycle 240 --sec-min-cycle 20 --swid-list "s21"
hnirrigationd_client --host localhost:8080 --create-zone --name "Back Pathway West" --sec-per-week 2520 --sec-max-cycle 240 --sec-min-cycle 20 --swid-list "s3"
hnirrigationd_client --host localhost:8080 --create-zone --name "Back Pathway East" --sec-per-week 2520 --sec-max-cycle 240 --sec-min-cycle 20 --swid-list "s2"
hnirrigationd_client --host localhost:8080 --create-zone --name "North Planter" --sec-per-week 2520 --sec-max-cycle 240 --sec-min-cycle 20 --swid-list "s13"
hnirrigationd_client --host localhost:8080 --create-zone --name "East Planter" --sec-per-week 2520 --sec-max-cycle 240 --sec-min-cycle 20 --swid-list "s12"
hnirrigationd_client --host localhost:8080 --create-zone --name "East Shrubs" --sec-per-week 2520 --sec-max-cycle 240 --sec-min-cycle 20 --swid-list "s16"
hnirrigationd_client --host localhost:8080 --create-zone --name "Southeast Berm" --sec-per-week 2520 --sec-max-cycle 240 --sec-min-cycle 20 --swid-list "s14"
hnirrigationd_client --host localhost:8080 --create-zone --name "Southwest Berm" --sec-per-week 2520 --sec-max-cycle 240 --sec-min-cycle 20 --swid-list "s15"
hnirrigationd_client --host localhost:8080 --create-zone --name "Garden" --sec-per-week 2520 --sec-max-cycle 240 --sec-min-cycle 20 --swid-list "s1"
hnirrigationd_client --host localhost:8080 --create-zone --name "Front Planter" --sec-per-week 2520 --sec-max-cycle 240 --sec-min-cycle 20 --swid-list "s9"
